...
from optimisation import DatasetsOptimisation
...
def the_optimisation(rseed):
    ...
    moop1 = DatasetsOptimisation(
        ...
        random_seed=rseed,
        data_folder='data',
        results_folder='results/moop1/')

    solver = NSGAII(
        problem=moop1,
        population_size=pop_size,
        offspring_population_size=pop_size,
        mutation=PolynomialMutation(probability=1.0/moop1.number_of_variables, distribution_index=20),
    ...
    write_front_tofile(moop1, front)
